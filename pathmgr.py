...
class PathManager:
    ...
    def get_full_classpath(java_cp, junit_cp):
        ...
        :return Full classpath that includes access to the project's Java source, tests, and JUnit lib files."""
        if java_cp is None:
    ...
    def path_name_to_packge_name(path_name):
        ...
        :returns Java package name given an OS path name."""
    ...
    def package_name_to_path_name(package_name):
        ...
        :returns OS path name given a Java package name."""
